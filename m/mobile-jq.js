...
$('#searchpage').live('pageshow',function(event, ui){
    $('#query').bind('change', function(e){
        ...
        var searchUrl =   'http://api.geonames.org/searchJSON?featureClass=P&maxRows=10&north=48.5&south=45.3&east=23&west=16&lang=hu&username=zmagyar';
        searchUrl += '&username=zmagyar&name_startsWith=' + $('#query')[0].value;
