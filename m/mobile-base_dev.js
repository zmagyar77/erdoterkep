    ...
    map = new OpenLayers.Map({
		...
		{singleTile: false, buffer: 0, isBaseLayer: true, transitionEffect: 'resize', alpha:0}
			...
			igazgatosagok = new OpenLayers.Layer.WMS(
                    "Kormányhivatalok", "http://erdoterkep.nebih.gov.hu/geoserver/nebih/wms",
                    {
                        layers: 'KUL_IGG',
                        srs: 'EPSG:23700',
                        format: 'image/png8',
			...
			korzetek = new OpenLayers.Layer.WMS(
                    "Erdőtervezési körzetek", "http://erdoterkep.nebih.gov.hu/geoserver/nebih/wms",
                    {
                        layers: 'MV_KORZETEK',
                        srs: 'EPSG:23700',
                        format: 'image/png8',
			...
			letesitmeny_uj = new OpenLayers.Layer.WMS(
                    "Új közjóléti létesítmények", "http://erdoterkep.nebih.gov.hu/geoserver/nebih/wms",
                    {
                        layers: 'KJ_LET_UJ_XE',
                        srs: 'EPSG:23700',
                        format: 'image/png8',
